...
use crate::{
    db::{
        models::{GnosisSafeDeposit, GnosisSafeTx, MintTx},
        Conn, MintAuditorDb,
    },
    gnosis::{
...
/// Test values.
pub const SAFE_ADDRESS: &str = "0xeC018400FFe5Ad6E0B42Aa592Ee1CF6092972dEe";
pub const ETH_TOKEN_CONTRACT_ADDRESS: &str = "0xD92E713d051C37EbB2561803a3b5FBAbc4962431";
pub const AUX_BURN_CONTRACT_ADDRESS: &str = "0x76BD419fBa96583d968b422D4f3CB2A70bf4CF40";
...
pub fn create_gnosis_safe_deposit(
    ...
    GnosisSafeDeposit::new(
        ...
        1,
        EthAddr::from_str(SAFE_ADDRESS).unwrap(),
        EthAddr::from_str(ETH_TOKEN_CONTRACT_ADDRESS).unwrap(),
        amount,
    )
}
...
pub fn insert_mint_tx_from_deposit(
    ...
    MintTx::insert(0, None, &mint_tx, conn).unwrap()
}
