...
- Use mnemonics instead of the deprecated root entropy derivation when generating test keys/ledgers. ([#1893])
...
- Remove `slam` application ([#1611])
- Remove `pretty_assertions` dependency ([#1055]) ([#1078]) ([#1431]) ([#1610]) ([#1657])
