...
fn main() {
    ...
    Builder::default()
        ...
        .use_core()
        // We allowlist only the exact stuff we want, because mcsgx-core-types-sys has the basic
        // stuff
        .allowlist_recursively(false)
        .allowlist_type("sgx_epid_group_id_t")
        .allowlist_type("_spid_t")
        .allowlist_type("_basename_t")
        .allowlist_type("_quote_nonce")
        .allowlist_type("sgx_quote_sign_type_t")
        .allowlist_type("_quote_t")
        .allowlist_type("_platform_info")
        .allowlist_type("_update_info_bit")
        .allowlist_var("SGX_PLATFORM_INFO_SIZE")
        .generate()
