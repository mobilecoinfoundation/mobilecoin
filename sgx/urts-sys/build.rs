...
fn main() {
    ...
    Builder::default()
        ...
        .use_core()
        // We allowlist only the exact stuff we want
        .allowlist_recursively(false)
        .allowlist_function("sgx_create_enclave")
        .allowlist_function("sgx_create_enclave_ex")
        .allowlist_function("sgx_create_enclave_from_buffer_ex")
        .allowlist_function("sgx_create_encrypted_enclave")
        .allowlist_function("sgx_destroy_enclave")
        .allowlist_function("sgx_get_target_info")
        .allowlist_var("MAX_EX_FEATURES_COUNT")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_PCL_BIT_IDX")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_PCL")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_SWITCHLESS_BIT_IDX")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_SWITCHLESS")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_KSS_BIT_IDX")
        .allowlist_var("SGX_CREATE_ENCLAVE_EX_KSS")
        .allowlist_type("_sgx_kss_config_t")
