...
fn main() {
    ...
    Builder::default()
        ...
        .header(header)
        .use_core()
        // We allow only the exact stuff we want, because mcsgx-core-types-sys has the basic
        // stuff
        .allowlist_recursively(false)
        .allowlist_function("sgx_init_quote")
        .allowlist_function("sgx_calc_quote_size")
        .allowlist_function("sgx_get_quote_size")
        .allowlist_function("sgx_get_quote")
        .allowlist_function("sgx_get_extended_epid_group_id")
        .allowlist_function("sgx_report_attestation_status")
        .allowlist_function("sgx_check_update_status")
        .generate()
