...
mod tests {
    ...
    fn test_avr_history_load_from_disk() {
        ...
        // Check that the loaded avr histories are the same as the control config
    ...
    fn test_avr_history_verification_works_for_valid_records() {
        // Create an avr verifier from the control avr history
        let control_avr_history = get_avr_history_config();
        ...
        // Check that the verifier matches the right data for each signing key
        ...
        // Check the verification records are correct
    ...
    fn test_avr_history_fails_for_invalid_ranges() {
        // Create history configs with invalid ranges
        let (avr1, avr2) = get_ias_reports();
