...
/// Struct representing history of Intel Attestation Verification
/// Reports (or AVR - represented by the [VerificationReport]
/// struct) for all consensus nodes mapped by block signing
/// key with which historical blocks can be verified.
///
...
pub struct AvrVerifier {
    /// Map of block signing key to [AvrVerificationRecord]
...
impl AvrVerifier {
    ...
    /// was produced by an Intel signed enclave.
    ///
    /// # Arguments
    ///
    ...
    /// the signing key in the [VerificationReport].
