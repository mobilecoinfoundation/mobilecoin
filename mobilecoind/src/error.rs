...
pub enum Error {
    ...
    #[fail(display = "Account key not encrypted.")]
    AccountKeyNotEncrypted,

    #[fail(display = "Password required to decrypt account key")]
    AccountKeyDecryption,

    #[fail(display = "No Account Key")]
    NoAccountKeyInMonitor,
