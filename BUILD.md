...
In order to run SGX securely with `SGX_MODE=HW` you will may need to change certain settings in your BIOS. These settings ensure reduce the risk of certain side-channel attacks and are required
