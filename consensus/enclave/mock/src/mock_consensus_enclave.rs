...
mock! {
    ...
    impl ReportableEnclave for ConsensusEnclave {
        ...
        fn verify_quote(&self, quote: Quote3<Vec<u8>>, qe_report: Report) -> SgxReportResult<IasNonce>;

        fn verify_ias_report(&self, ias_report: Evidence) -> SgxReportResult<()>;

        fn get_ias_report(&self) -> SgxReportResult<Evidence>;
    }
}
