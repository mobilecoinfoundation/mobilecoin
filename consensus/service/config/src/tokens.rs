...
mod tests {
    ...
    fn valid_minting_config() {
        ...
        let input_toml: &str = r#"
            ...
            master_minters_signature = "95039968eaef6a365c5d193059d5bbbc96c3720a9590b733779016caf1009dde9d4faba6925ca44cca9ef64c92735df2d6301923fe4d9c9e14988d72864da509"
       ...
       "#;
        ...
        tokens
            .verify_master_minters_signature(&Ed25519Public::from(&minting_trust_root_private_key))
            .unwrap();
    }
