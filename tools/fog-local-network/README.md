...
4) Wait for the network to start. This takes awhile. You can tell by looking at
...
In order to provide a way to easily replace the wallet implementation with a
