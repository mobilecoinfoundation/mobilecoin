...
- name: fog-view-store
  ...
  - name: MC_CLIENT_LISTEN_URI
    value: "insecure-fog-view-store://0.0.0.0:3225/?responder-id=$(POD_NAME).{{ include "fog-view-fsg.fullname" . }}-store-headless.$(POD_NAMESPACE):3225"
  - name: MC_CLIENT_RESPONDER_ID
    value: "$(POD_NAME).{{ include "fog-view-fsg.fullname" . }}-store-headless.$(POD_NAMESPACE):3225"
  - name: MC_ADMIN_LISTEN_URI
    value: insecure-mca://127.0.0.1:8001/
  - name: FOGDB_HOST
    valueFrom:
