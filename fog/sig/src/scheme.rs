...
//! This module provides the "all-in-one" roll-up trait which supports the
//! complete validation and extraction of the ingest public key.

mod public_address;

use crate::authority::{Error as AuthorityError, Verifier as AuthorityVerifier};
