...
lazy_static! {
    ...
    .expect("metric cannot be created");
    pub static ref BULK_STORE_QUERY_REQUESTS: Histogram = register_histogram!(histogram_opts!(
    ...
    pub static ref CONNECTED_CLIENTS: IntGauge =
        register_int_gauge!("fog_ledger_router_connected_clients", "Connected Clients")
            .expect("metric cannot be created");
}
