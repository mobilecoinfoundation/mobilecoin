...
#[derive(Clone)]
pub struct LedgerStoreService<L: Ledger + Clone, E: LedgerEnclaveProxy> {
    ledger: L,
    watcher: WatcherDB,
    enclave: E,
...
impl<L: Ledger + Clone, E: LedgerEnclaveProxy> LedgerStoreService<L, E> {
    pub fn new(
        ledger: L,
        watcher: WatcherDB,
        enclave: E,
    ...
    fn query(
        ...
        let result_blob = self
            .enclave
            .handle_ledger_store_request(request.into(), untrusted_query_response)
