...
fn create_stores(
    ...
    for _ in 0..store_count {
        ...
        let watcher_db_tmp =
            TempDir::new("fog-watcher").expect("Could not make tempdir for watcher db");
...
fn create_router(
    ...
    let router = KeyImageRouterServer::new(config, enclave, shards, logger.clone());
