...
mod tests {
    ...
    #[test]
    fn test_destination_memo_static() {
        let alice_bytes : [u8; 657]= hex::decode(&"").unwrap().try_into().unwrap();
        let alice: AccountKey = mc_util_serial::decode(&alice_bytes).unwrap();
        ...
        let hash_data: [u8; 16] = <[u8; 16]>::from(memo.get_address_hash().clone());

        println!("Destination Memo payload:  is: {}", hex::encode(memo_bytes));
        println!("Destination Memo addresss hash:  is: {}", hex::encode(hash_data));
        println!("Destination Memo fee:  is: {}", memo.get_fee());
        println!("Destination Memo total outlay:  is: {}", memo.get_total_outlay());
        println!("Destination Memo number of recipients:  is: {}", memo.get_num_recipients());
    }
}
