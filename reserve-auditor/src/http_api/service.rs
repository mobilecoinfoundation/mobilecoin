...
use crate::{
    db::{AuditedBurn, AuditedMint, BlockAuditData, BlockBalance, Counters, ReserveAuditorDb},
...
impl ReserveAuditorHttpService {
    ...
    pub fn new(reserve_auditor_db: ReserveAuditorDb) -> Self {
...
mod tests {
    ...
    fn test_get_block_audit_data(logger: Logger) {
        ...
        let service = ReserveAuditorHttpService::new(reserve_auditor_db);
    ...
    fn test_get_audited_burns_service(logger: Logger) {
        ...
        let service = ReserveAuditorHttpService::new(burn_auditor_db);
